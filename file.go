...
// with something. NewFile() returning File makes it a one-liner.
//
//	photo := &crare.Photo{File: crare.FromURL("https://site.com/picture.jpg")}
...
// with something. NewFile() returning File makes it a one-liner.
//
//	photo := &crare.Photo{File: crare.FromReader(bytes.NewReader(...))}
