...
func TestBotHandle(t *testing.T) {
	if b == nil {
		t.Skip("Cached bot instance is bad (probably wrong or empty CRARE_SECRET)")
	}
...
func TestBotStart(t *testing.T) {
	if token == "" {
		t.Skip("CRARE_SECRET is required")
	}
